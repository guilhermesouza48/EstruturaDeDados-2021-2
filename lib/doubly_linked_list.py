...
"""
    ...
    2) Onde fica armazenada a informação  revelante para o usúario (data)
...
class Node:
    def __init__(self, val):
        ...
        self.data = val # Armazena o informação do usuário
        self.next = None # Ponteiro para próximo  nodo (None =  nenhum)
...
class DoublyLinkedList:
    ...
    def find_node(self,pos):
        ...
        # Se, ao contrário, o nodo estiver na segunda metade da lista,
        # compensa mais fazer um percurso reverso desde o __tail
        else:
            node = self.__tail
...
# Inserção emm posição  intermediaria
lista.insert(6, 'Gol')
print(lista.to_str())
