class Deque:
    ...
    """
        ...
        Retorna True se vazio False caso contrário
    """
...
# Inserções "Normais"
deque.insert_back("Gabriel")
deque.insert_back("Erick")
deque.insert_back("Guilherme")
deque.insert_back("Valéria")
deque.insert_back("Nickolas")
deque.insert_back("Otávio")
deque.insert_back("Leonardo")

print(deque.to_str())

# Inserções prioritárias
deque.insert_front("Murillo")
deque.insert_front("Thiago")
deque.insert_front("Danilo")
deque.insert_front("Rafael")
deque.insert_front("Fausto")
deque.insert_front("Neto")
