...
# Percorre a lista a ser ordenada em sucessivas  passadas, trocando elementos adjacentes
# entre si quando o segundo for  menor que o primeiro. Efetua tantas  passadas quanto 
# necessárias até que, na  última passada, nenhuma troca seja efetuada.
...
def bubble_sort(lista):
    ...
    while True: # Loop eterno
        ...
        for i in (range(lista) - 2):       # Inicia nova passada
